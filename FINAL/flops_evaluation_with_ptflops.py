...
mf_flops, _ = get_model_complexity_info(MobileFormer(config_294), model_image_size, as_strings=False, print_per_layer_stat=False)
co_flops, _ = get_model_complexity_info(CoAtNet(model_image_size[1], model_image_size[2], model_image_size[0], config=f'coatnet-3', num_classes=num_classes), model_image_size, as_strings=False, print_per_layer_stat=False)
mfra_flops, _ = get_model_complexity_info(MobileFormerRA(config_294), model_image_size, as_strings=False, print_per_layer_stat=False)
