...
mf_flops, _ = profile(MobileFormer(config_294), inputs=(input, ))
co_flops, _ = profile(CoAtNet(model_image_size[1], model_image_size[2], model_image_size[0], config=f'coatnet-3', num_classes=num_classes), inputs=(input, ))
mfra_flops, _ = profile(MobileFormerRA(config_294), inputs=(input, ))
