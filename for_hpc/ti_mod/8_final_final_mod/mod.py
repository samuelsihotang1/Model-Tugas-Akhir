...
def _assign_hyperparameter(args):
    ...
    args.pretrained_path = '/home/tasi2425111/for_hpc/baru/ti_mod/8_final_final_mod/checkpoint-17.pth.tar'
    # Resume full model and optimizer state from checkpoint (default: '')
    args.resume = '/home/tasi2425111/for_hpc/baru/ti_mod/8_final_final_mod/checkpoint-17.pth.tar'
